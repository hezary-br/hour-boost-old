...
declare namespace jest {
  ...
  interface Each {
    ...
    <T>(
      cases: readonly T[]
    ): (name: string, fn: (arg: T, done: DoneCallback) => any, timeout?: number) => void
    (
    ...
    (
      ...
      ...placeholders: any[]
    ): (name: string, fn: (arg: any, done: DoneCallback) => any, timeout?: number) => void
  }
   ...
   */
  type Spied<T extends (abstract new (...args: any) => any) | ((...args: any) => any)> =
